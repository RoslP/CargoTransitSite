...
<div class="container">
    <form class="row registration-form  justify-content-center justify-content-md-center" method="post"
        ...
        <h4>Авторизация</h4>
        <div class="col-12 col-mb-4 errString">
            <?php echo DataProcessing::$ErrIfStingEmpty ?>
        </div>
        <div class="w-100"></div>
        <div class="col-12 col-md-4">
            <label for="validationLoginAuth" class="form-label">Логин</label>
            <input name="login" type="text" class="form-control" id="validationLoginAuth" placeholder="Введите логин">
        </div>
        <div class="w-100"></div>
        <div class="col-12  col-md-4">
            <label for="validationPasswordAuth" class="form-label">Пароль</label>
            <input name="password" type="password" class="form-control" id="validationPasswordAuth"
                   placeholder="Введите пароль">
        </div>
        <div class="w-100"></div>
        <div id="AuthBnt" class=" col-12 col-md-4">
            <button name="button-auth" class="btn btn-primary col-md-6" type="submit">Войти</button>
